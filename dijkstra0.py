...
def _calc_paths ():
  ...
  delay = []
  #line1
  line.append(range(28))
  delay.append([2,2,3,3,2,3,2,3,3,2,2,3,1,2,2,3,2,2,2,2,3,2,3,3,3,2,2])
  #line2
  line.append(range(28,46)+[15]+range(46,57))
  delay.append([3,7,5,3,5,3,3,1,3,2,4,1,3,3,2,2,3,3,2,2,3,3,2,3,2,3,7,2,3])
  #line3
  line.append([23]+range(57,63)+[49]+range(63,67)+[12]+range(67,83))
  delay.append([23]+range(57,63)+[49]+range(63,67)+[12]+range(67,83))
  #line4
  line.append(range(60,63)+[49]+range(63,67)+[13,68]+range(83,88)+[43]+range(88,97)+[22])
  delay.append(range(60,63)+[49]+range(63,67)+[13,68]+range(83,88)+[43]+range(88,97)+[22])
  #line5
  line.append([27]+range(97,107))
  delay.append([2,2,4,3,3,2,3,2,3,2])
  #line6
  line.append(range(107,123)+[43,124,90]+range(124,133))
  delay.append([2,3,3,3,2,2,2,2,3,2,2,3,2,2,3,2,3,2,3,2,3,2,3,2,2,2,2])
  #line7
  line.append([133,39,134,135,136,126]+range(137,142)+[95,142,18,47,143,144,65]+range(145,160))
  delay.append([3,2,3,2,3,2,2,2,2,3,2,2,3,2,3,2,2,3,2,2,2,2,3,2,2,3,3,6,3,2,4,2])
  #line8
  line.append(range(160,166)+[132,166,167,138,168,92,169,170,171,15,172,173,174,69]+range(175,185))
  delay.append([2,2,2,4,3,4,2,2,2,2,3,2,2,2,2,2,2,3,2,3,2,2,2,2,2,2,2,2,1])
  #line9
  line.append([185,42,186,187,169,188,189,190,142,20,60]+range(191,206))
  delay.append([4,2,4,3,2,2,2,2,3,3,3,3,2,3,3,3,4,6,5,3,4,4,3,3,4])
  #line10
  line.append(range(206,212)+[176,213,83,214,215,45,216,170,217,17,18,218,219,61]+range(220,226)+[54,55])
  delay.append([1,2,3,2,2,2,2,2,2,3,2,2,3,2,3,3,2,3,2,2,3,2,2,2,3,4,1])
  #line11
  line.append(range(226,233)+[132]+range(233,237)+[20,219,48,238,64]+range(239,248)+range(252,259))
  delay.append([2,3,5,3,2,5,3,2,2,3,3,3,4,2,2,2,2,3,2,3,2,2,5,5,3,4,6,3,3,2,3,2])
  #line12
  line.append(range(259,263)+[114]+range(263,269)+[85,269,270,215,172,13,46,17,190,94,141,235,58,22]+range(271,278))
  delay.append([2,3,2,3,2,2,2,3,2,3,3,2,3,2,3,3,3,3,2,2,2,2,3,2,2,3,3,2,2,3,3])
  #line13
  line.append(range(278,284)+[63,238,284,144,285,13,286,46,287,217,188,288,289])
  delay.append([2,4,3,2,3,4,2,3,2,2,3,1,3,2,3,2,2,3])
  #line16
  line.append([39,290,228]+range(291,301))
  delay.append([5,5,4,4,3,4,6,7,6,10,6,4])
  ...
  for k in sws:
    for j,port in adjacency[k].iteritems():
      if port is None: continue
      for l in line:
        if k-1 in l and j-1 in l:
          if l.index(k-1)-l.index(j-1)==1:
            path_map[k][j] = (delay[line.index(l)][j-1],None)
          elif l.index(k-1)-l.index(j-1)==-1:
            path_map[k][j] = (delay[line.index(l)][k-1],None)
    path_map[k][k] = (0,None) # distance, intermediate
  #dump()
  ...
  for u in sws:
    ...
    while len(N)<len(sws):
      ...
      for v in sws:
        if v not in N:
          if path_map[u][v][0] is not None and path_map[u][v][0]<mind:
            w = v
            mind = path_map[u][v][0]
      if w==u:
        print "ERROR: swhich not connected to any other nodes"
      #add w to N
      N.append(w)
      ...
      for v in sws:
        if v not in N and path_map[w][v][0] is not None:
